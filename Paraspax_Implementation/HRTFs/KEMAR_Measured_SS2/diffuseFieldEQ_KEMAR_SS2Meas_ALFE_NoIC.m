...
%
% script diffuseFieldEQ_KEMAR_SS2Meas_ALFE_NoIC
%
...
load('KEMAR_HRIRs_MeasSS2_ALFE_sfd_N35');
...
%Save all in struct
DFR.dummyHead = 'KEMAR_MeasSS2_ALFE';
DFR.fs = fs;
DFR.dfr = dfr;
DFR.dfrInv = dfrInv;
DFR.dfr_sm = dfr_sm;
...
save('DFR_KEMAR_MeasSS2_ALFE','DFR');
...
%Save
save('BinauralWhiteNoise_KEMAR_MeasSS2_ALFE_Artificial_NoIC','binNoise');
